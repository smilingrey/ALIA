...
<?php
$id_siup = (int)$_GET["id_siup"];
$d = mysql_query("select * from tbl_siup where id_siup='$id_siup'");
$d1 = mysql_fetch_array($d);
?>
<div id="judul_content"><h2>EDIT DATA SIUP</h2></div>
...
<form action="./index.php?mod=home&opt=siup&opts=validasi&mode=2&id_siup=<?php echo $id_siup; ?>" method="post">
...
<tr id="tbl-content">
    ...
    <td><input type="text" name="perusahaan" size="30"   value="<?php echo $d1["nama_perusahaan"]; ?>" required/></td>
</tr>
<tr id="tbl-content">
...
<tr id="tbl-content">
	<td>NPWP</td>
    <td><input type="text" name="npwp" size="30"   value="<?php echo $d1["npwp"]; ?>" required/></td>
</tr>
<tr id="tbl-content">
	<td>NILAI MODAL KEKAYAAN BERSIH</td>
    <td><input type="text" name="modal" size="30"   value="<?php echo $d1["modal"]; ?>" required/></td>
</tr>
<tr id="tbl-content">
...
<tr id="tbl-content">
	<td>BIDANG USAHA</td>
    <td><input type="text" name="bidang" size="40"  value="<?php echo $d1["bidang"]; ?>" required/></td>
</tr>
<tr id="tbl-content">
	<td>JENIS BARANG/JASA DAGANGAN UTAMA</td>
    <td><textarea name="dagangan" rows="4" cols="30"   required><?php echo $d1["dagangan"]; ?></textarea></td>
</tr>
<tr id="tbl-content">
	<td>KELEMBAGAAN</td>
    <td><input type="text" name="kelembagaan" size="40"  value="<?php echo $d1["kelembagaan"]; ?>" required/></td>
</tr>
<tr id="tbl-content">
	<td>PEMILIK</td>
...
<tr id="tbl-content">
    ...
    <td><input type="text" name="alamat_pemilik" size="40"  value="<?php echo $d1["alamat_pemilik"]; ?>" required/></td>
</tr>
