    ...
    <body>
        <table width="100%" cellspacing="0" cellpadding="0" class="ttd">
            <tr>
                ...
                <td align="center" class="judul">LAPORAN PENDATAAN SURAT IZIN GANGGUAN<br>
												<?php echo skpd(); ?><br>
												<?php echo pemerintah(); ?>
                </td>
            </tr>
        ...
        <table width="100%" cellspacing="0" cellpadding="1" border="1">
            <thead>
                <tr>
                    ...
                    <th >LUAS TEMPAT USAHA (m<sup>2</sup>)</th>
...
<?php
	if(!empty($_GET["nama"]) || !empty($_GET["nim"]) || !empty($_GET["tgl1"]) || !empty($_GET["tgl2"]))
	{
		$qsrt = mysql_query("select * from tbl_ho where id_ho is not null and ".$up." order by no_sk ");
	}
	else
	{
		$qsrt = mysql_query("select * from tbl_ho order by no_sk ");
	}
?>				
