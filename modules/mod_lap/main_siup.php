<script type="text/javascript">
	...
	function Kirim_Cari()
	{
		...
		var s;
		s='./index.php?mod=home&opt=lap&opts=siup';
...
<div id="judul_content"><h2>LAPORAN ARSIP SIUP</h2></div>
...
<?php
	...
	echo '</span></form>';
?>
	<div><a href="./modules/mod_lap/cetak_siup.php?nama=<?php echo $_GET["nama"];?>&nim=<?php  echo $_GET["nim"];?>&tgl1=<?php  echo $_GET["tgl1"];?>&tgl2=<?php  echo $_GET["tgl2"];?>" class="link" target="_blank"><button>CETAK</button></a></div><br />
    ...
    <tr id="tbl-label">
        ...
        <td >ALAMAT PENANGGUNGJAWAB / PEMILIK</td>
        <td >NPWP</td>
