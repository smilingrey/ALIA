    ...
    <body>
        <table width="100%" cellspacing="0" cellpadding="0" class="ttd">
            <tr>
                ...
                <td align="center" class="judul">LAPORAN PENDATAAN SURAT IZIN USAHA PERDAGANGAN<br>
												<?php echo skpd(); ?><br>
												<?php echo pemerintah(); ?>
                </td>
            </tr>
        ...
        <table width="100%" cellspacing="0" cellpadding="1" border="1">
            <thead>
                <tr>
                    ...
                    <th >ALAMAT PENANGGUNGJAWAB / PEMILIK</th>
                    <th >NPWP</th>
                    <th >NILAI MODAL KEKAYAAN BERSIH</th>
                    <th >KEGIATAN USAHA</th>
                    <th >KELEMBAGAAN</th>
                    <th >BIDANG</th>
                    <th >JENIS BARANG / JASA DAGANGAN UTAMA</th>
...
<?php
	if(!empty($_GET["nama"]) || !empty($_GET["nim"]) || !empty($_GET["tgl1"]) || !empty($_GET["tgl2"]))
	{
		$qsrt = mysql_query("select * from tbl_siup where id_siup is not null and ".$up." order by no_sk ");
	}
	else
	{
		$qsrt = mysql_query("select * from tbl_siup order by no_sk ");
	}
?>				
...
?>
                ...
                <tr>
                    ...
                    <td align="left" valign="top"><?php echo $bsrt["alamat_pemilik"]; ?></td>
                    <td align="left" valign="top"><?php echo $bsrt["npwp"]; ?></td>
                    <td align="left" valign="top"><?php echo $bsrt["modal"]; ?></td>
                    <td align="left" valign="top"><?php echo $bsrt["kegiatan"]; ?></td> 
                    <td align="left" valign="top"><?php echo $bsrt["kelembagaan"]; ?></td> 
                    <td align="left" valign="top"><?php echo $bsrt["bidang"]; ?></td> 
                    <td align="left" valign="top"><?php echo $bsrt["dagangan"]; ?></td> 
...
<?php
    ...
    $dompdf->stream("lap_ho.pdf", array("Attachment" => false));
