<script type="text/javascript">
	...
	function Kirim_Cari()
	{
		...
		var s;
		s='./index.php?mod=home&opt=lap&opts=st';
...
<div id="judul_content"><h2>LAPORAN ARSIP SURAT KETERANGAN TANAH</h2></div>
...
<?php
	...
	echo '</span></form>';
?>
	<div><a href="./modules/mod_lap/cetak_st.php?nama=<?php echo $_GET["nama"];?>&nim=<?php  echo $_GET["nim"];?>&tgl1=<?php  echo $_GET["tgl1"];?>&tgl2=<?php  echo $_GET["tgl2"];?>" class="link" target="_blank"><button>CETAK</button></a></div><br />
...
<?php
	...
	$qry  = mysql_query("select kecamatan from ref_kecamatan where id_kecamatan='".$bsrt["id_kecamatan"]."'");
	$qrys = mysql_fetch_array($qry);
	$kec=$qrys["kecamatan"];			 
?>
	<tr id="tbl-content">
        ...
        <td align="left" valign="top"><?php echo $kec; ?></td>
        <td align="left" valign="top"><?php echo $bsrt["luas"]; ?></td>     
