...
<div id="judul_content"><h2>TAMBAH DATA IZIN GANGGUAN</h2></div>
...
<form action="./index.php?mod=home&opt=ho&opts=validasi&mode=1" method="post">
...
<tr id="tbl-content">
    ...
    <td><input type="text" name="perusahaan" size="40"  required/></td>
</tr>
<tr id="tbl-content">
