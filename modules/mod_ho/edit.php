...
$d = mysql_query("select * from tbl_ho where id_ho='$id_ho'");
$d1 = mysql_fetch_array($d);
?>
<div id="judul_content"><h2>EDIT DATA IZIN GANGGUAN</h2></div>
<div align="right"><a href="./index.php?mod=home&opt=ho&opts=list" class="link" title="Klik untuk kembali ke halaman sebelumnya"><button>KEMBALI</button></a></div><br />
<form action="./index.php?mod=home&opt=ho&opts=validasi&mode=2&id_ho=<?php echo $id_ho; ?>" method="post">
...
<tr id="tbl-content">
    ...
    <td><input type="text" name="perusahaan" size="50"  value="<?php echo $d1["nama_perusahaan"]; ?>" required/></td>
</tr>
<tr id="tbl-content">
