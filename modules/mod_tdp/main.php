<script type="text/javascript">
	function tampil(c,uid)
	{
			...
			if(t.innerHTML != ''){
				...
				t.innerHTML='<iframe src="./modules/mod_tdp/tampil.php?link='+c+'&id_user='+uid+'" width="100%" style="height:800px" frameborder="0" scrolling="no" id="iframe_detail"></iframe>';
	...
	function Kirim_Cari()
	{
		...
		var s;
		s='./index.php?mod=home&opt=tdp&opts=list';
...
<div id="judul_content"><h2>DATA TANDA DAFTAR PERUSAHAAN</h2></div>


		<form name="fcari" method="post">
        <table cellpadding="4px" cellspacing="0px" border="0" align="left"id="tbl" >
        <tr id="tbl-label">
            <td width="30%" align="right">NOMOR TDP</td>
...
<?php
	...
	echo '</span></form>';
?>
	<div><a href="./index.php?mod=home&opt=tdp&opts=tambah" class="link" title="Klik untuk tambah"><button>TAMBAH DATA TDP</button></a></div><br />
    <table cellpadding="3" cellspacing="1" align="center" id="tbl" width="100%">
    <tr id="tbl-label">
        <td width="5%">NO</td>
        <td align="left">NOMOR TDP</td>
...
?>
	<tr id="tbl-content">
        ...
        <td align="center" valign="top"><a class="edit" href="./index.php?mod=home&opt=tdp&opts=edit&id_tdp=<?php echo $bsrt["id_tdp"]; ?>"><button>EDIT</button></a></td>
        <td align="center" valign="top"><a class="hapus" href="./index.php?mod=home&opt=tdp&opts=validasi&mode=3&id_tdp=<?php echo $bsrt["id_tdp"]; ?>" onClick="return confirm('Apakah Anda yakin ingin menghapus data ini?' + '\nNomor Surat: ' + '<?php echo $bsrt["no_sk"]; ?>' + '\n\n' + 'Jika YA silahkan klik OK, Jika TIDAK klik CANCEL.')"><button>HAPUS</button></a></td>
    </tr>
<?php echo
    "<tr id='tbl-content'>
