...
<div id="judul_content"><h2>TAMBAH DATA TDP</h2></div>
...
<form action="./index.php?mod=home&opt=tdp&opts=validasi&mode=1" method="post">
...
<tr id="tbl-content">
	<td>STATUS</td>
    <td><input type="text" name="status" size="30"   required/></td>
</tr>
<tr id="tbl-content">
